...
- **主地图页面**: http://localhost:18088
- **健康检查**: http://localhost:18088/health
- **具体文件**: http://localhost:18088/新疆伊犁旅游自驾路线地图.html
...
4. **⏳ 健康检查阶段**
   - 等待服务完全启动（最多 60 秒）
   - 检查健康检查端点：`http://localhost:18088/health`
   - 确保服务正常响应
